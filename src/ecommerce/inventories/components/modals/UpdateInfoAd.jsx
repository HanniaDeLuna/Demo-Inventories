...
const UpdateInfoAd = ({ UpdateInfoAdShowModal, setUpdateInfoAfShowModal, InfoAdSel}) => {
...
const fetchInfoAd = async () => {
    try { 
        const data = await getInfoAd(InfoAdSel.IdEtiquetaOK); 
        console.log(data);
        formik.setValues({
            ...
            Valor: data.Valor || '',
            IdTipoSeccionOK: data.IdTipoSeccionOK || '',
  ...
  const formik = useFormik({
    ...
    onSubmit: async (values) => {
      ...
      try {
        ...
        await putInfoAd(InfoAdSel.IdEtiquetaOK, InfoAd);
        setMensajeExitoAlert("Informacuón creada y guardada Correctamente");
  ...
  return (
    <Dialog
      ...
      onClose={() => setUpdateInfoAfShowModal(false)}
      fullWidth
    >
      <form onSubmit={formik.handleSubmit}>
        ...
        <DialogActions sx={{ width: "auto" }}>
          ...
          <LoadingButton
            ...
            startIcon={<CloseIcon />}
            variant="outlined"
            onClick={() => setUpdateInfoAfShowModal(false)}
          >
            <span>CERRAR</span>
          </LoadingButton>
          <LoadingButton
